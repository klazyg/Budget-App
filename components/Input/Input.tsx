...
const Input: React.FC<Props> = ({ onSubmitTransaction }) => {
  ...
  const onSubmitTransactions = (transaction: Transaction) => {
    if (transaction.type === 'income') {
      setIncomeTransactions(prevTransactions => [...prevTransactions, transaction]);
    } else if (transaction.type === 'spend') {
      setSpendTransactions(prevTransactions => [...prevTransactions, transaction]);
    } else if (transaction.type === 'savings') {
      setSavingsTransactions(prevTransactions => [...prevTransactions, transaction]);
    }
